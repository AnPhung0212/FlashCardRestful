package com.anpk.firstDemoLearnSpring.helpers.templates;

public final class RegisterEmailTemplate {
...
<style>
body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333333; margin: 0; padding: 0; background-color: #f7f7f7; }
...
.email-footer { background-color: #f1f1f1; padding: 20px; text-align: center; font-size: 12px; color: #666666; border-radius: 0 0 5px 5px; }
...
.social-links a { margin: 0 10px; text-decoration: none; color: #4b6cb7; }
@media screen and (max-width: 600px) { .email-body { padding: 20px; } }
</style>
</head>
<body>
...
""";
    ...
    public static String render(String name, String confirmUrl) {
        return TEMPLATE
